...
public class GridSystem<TGridObject>
{
    ...
    {
        return new Vector3(gridPosition.x, 0, gridPosition.z) * cellSize + new Vector3(0, gridPosition.floor, 0) * floorHeight;
    }
    ...
    public void CreateDebugObjects(Transform debugPrefab, int floor)
    {
        for (int x = 0; x < width; x++)
        {
            for (int z = 0; z < height; z++)
